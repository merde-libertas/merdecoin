...
EXPECTED_HOLDER_NAMES = [
    "Satoshi Nakamoto\n",
    "The Merdecoin Core developers\n",
    "Merdecoin Core Developers\n",
    "BitPay Inc\.\n",
...
Arguments:
    <base_directory> - The base directory of a merdecoin source code repository.
...
Arguments:
    <file> - A source file in the merdecoin repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Merdecoin
