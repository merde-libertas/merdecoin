Merdecoin Core version 0.16.3 is now available from:

  <https://merdecoincore.org/bin/merdecoin-core-0.16.3/>
...
been discovered in Merdecoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` merdecoinconsensus: invalid flags error should be set to `merdecoinconsensus_err` (afk11)
