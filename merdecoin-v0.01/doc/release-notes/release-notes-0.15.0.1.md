Merdecoin Core version *0.15.0.1* is now available from:

  <https://merdecoin.org/bin/merdecoin-core-0.15.0.1/>

and

  <https://merdecoincore.org/bin/merdecoin-core-0.15.0.1/>
