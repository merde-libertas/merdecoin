Merdecoin Core version 0.16.1 is now available from:

  <https://merdecoincore.org/bin/merdecoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting merdecoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure merdecoind processes are cleaned up when tests end (sdaftuar)
