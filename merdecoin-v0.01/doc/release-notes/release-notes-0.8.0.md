Merdecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/merdecoin/files/Merdecoin/merdecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Merdecoin
...
New/changed settings (command-line or merdecoin.conf file)
--------------------------------------------------------
