Merdecoin Core version 0.11.1 is now available from:

  <https://merdecoin.org/bin/merdecoin-core-0.11.1/>
...
(see https://github.com/merdecoin/merdecoin/pull/6795).
...
one was randomly violated by all deployed merdecoin software prior to
...
Merdecoin Core has produced compatible signatures since a28fb70e in
September 2013, but this didn't make it into a release until 0.9
in March 2014; Merdecoinj has done so for a similar span of time.
Merdecoinjs and electrum have been more recently updated.
...
[1] On the Malleability of Merdecoin Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/merdecoin/paper_9.pdf
...
(see https://github.com/merdecoin/merdecoin/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libmerdecoinconsensus: avoid a crash in multi-threaded environments
