...
// merdecoin includes.
#include <..\src\script\merdecoinconsensus.h>
...
int main()
{
    std::cout << "merdecoinconsensus version: " << merdecoinconsensus_version() << std::endl;
    ...
    auto op0Result = merdecoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, merdecoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
