...
/** Merdecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class MerdecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit MerdecoinUnits(QObject *parent);

    /** Merdecoin units.
      @note Source: https://en.merdecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MRD,
...
typedef MerdecoinUnits::Unit MerdecoinUnit;
