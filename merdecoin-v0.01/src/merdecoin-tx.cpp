...
static void SetupMerdecoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " merdecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  merdecoin-tx [options] <hex-tx> [commands]  Update hex-encoded merdecoin transaction\n" +
            "or:     merdecoin-tx [options] -create [commands]   Create hex-encoded merdecoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded merdecoin transaction
