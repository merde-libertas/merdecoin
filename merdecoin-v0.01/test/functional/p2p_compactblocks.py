...
# TestP2PConn: A peer we use to send messages to merdecoind, and store responses.
...
class CompactBlocksTest(MerdecoinTestFramework):
    ...
    # This test actually causes merdecoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that merdecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for merdecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # merdecoind will not send blocktxn responses for blocks whose height is
