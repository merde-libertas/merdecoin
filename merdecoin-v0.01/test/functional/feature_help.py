...
"""Verify that starting merdecoin with -h works as expected."""

from test_framework.test_framework import MerdecoinTestFramework
from test_framework.util import assert_equal

class HelpTest(MerdecoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start merdecoin with -h for help text")
        ...
        self.log.info("Start merdecoin with -version for version information")
        ...
        self.log.info("Start merdecoind with -fakearg to make sure it does not start")
