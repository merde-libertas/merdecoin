...
enum WalletFlags : uint64_t {
    ...
    //! merdecoin from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The Merdecoin Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this merdecoin node, and set to 0 for transactions that were created
