...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, MerdecoinUnits::SeparatorStyle separators=MerdecoinUnits::separatorStandard) const;
