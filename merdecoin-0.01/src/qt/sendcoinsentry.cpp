    ...
    platformStyle(_platformStyle)
{
    ...
    // normal merdecoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying merdecoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &MerdecoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
