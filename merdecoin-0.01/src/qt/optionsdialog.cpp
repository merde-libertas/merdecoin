    ...
    mapper(nullptr)
{
    ...
    ui->merdecoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->merdecoinAtStartup);
    ...
    ui->merdecoinAtStartup->setToolTip(ui->merdecoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->merdecoinAtStartup->setText(ui->merdecoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openMerdecoinConfButton->setToolTip(ui->openMerdecoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new MerdecoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->merdecoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openMerdecoinConfButton_clicked()
{
