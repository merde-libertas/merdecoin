This directory contains the MerdecoinQT graphical user interface (GUI). It uses the cross-platform framework [Qt](https://www1.qt.io/developers/).
...
Represents the main window of the Merdecoin UI.
...
ClientModel is used by the main application `merdecoingui` and several models like `peertablemodel`.
...
Used to process BIP21 and BIP70 (see https://github.com/merdecoin/merdecoin/pull/11622) payment URI / requests. Also handles URI based application switching (e.g. when following a merdecoin:... link from a browser).
...
* UI elements like MerdecoinAmountField, which inherit from QWidget.
* `merdecoinstrings.cpp`: automatically generated
* `merdecoinunits.(h/cpp)`: MRD / mMRD / etc handling
* `callback.h`
...
* don't change `local/merdecoin_en.ts`; this happens [automatically](/doc/translation_process.md#writing-code-with-translations)
...
4. Enter "merdecoin-qt" as project name, enter src/qt as location
5. Leave the file selection as it is
6. Confirm the "summary page"
7. In the "Projects" tab select "Manage Kits..."
8. Select the default "Desktop" kit and select "Clang (x86 64bit in /usr/bin)" as compiler
9. Select LLDB as debugger (you might need to set the path to your installation)
10. Start debugging with Qt Creator (you might need to the executable to "merdecoin-qt" under "Run", which is where you can also add command line arguments)
