...
/* A AEAD class for ChaCha20-Poly1305@merdecoin.
 *
 ...
 *
 * The chacha20-poly1305@merdecoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@merdecoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@merdecoin are relatively fast in
