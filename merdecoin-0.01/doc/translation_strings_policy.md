...
This document provides guidelines for internationalization of the Merdecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `merdecoin_en.ts` remains unchanged.
