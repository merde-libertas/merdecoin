...
## `disable-wallet` mode
When the intention is to run only a P2P node without a wallet, Merdecoin Core may be
...
The first time you run merdecoind, it will start downloading the blockchain. This process could
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/merdecoin-core/merdecoin-detached-sigs).
