Merdecoin Core version 0.10.4 is now available from:

  <https://merdecoin.org/bin/merdecoin-core-0.10.4/>
...
- #6953 `43c2789` Split merdecoin-tx into its own package
- #6953 `dfe0d4d` Include merdecoin-tx binary on Debian/Ubuntu
