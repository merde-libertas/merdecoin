Merdecoin Core version *0.15.2* is now available from:

  <https://merdecoincore.org/bin/merdecoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in merdecoin-tx (TheBlueMatt)
