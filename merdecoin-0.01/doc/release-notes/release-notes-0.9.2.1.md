Merdecoin Core version 0.9.2.1 is now available from:

  https://merdecoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MRD to 0.01 MRD
...
- Fix "Start merdecoin on system login"
