Merdecoin Core version 0.13.2 is now available from:

  <https://merdecoin.org/bin/merdecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update merdecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow merdecoin-tx to create v2 transactions (btcdrak)
