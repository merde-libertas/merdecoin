Merdecoin version 0.5.0 is now available for download at:
...
If you have a previously encrypted wallet.dat, the first time you run bitcoin-qt or bitcoind the wallet will be rewritten, Merdecoin will
