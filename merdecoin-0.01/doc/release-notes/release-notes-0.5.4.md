Merdecoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/merdecoin/files/Merdecoin/merdecoin-0.5.4/
...
http://gitorious.org/merdecoin/merdecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Merdecoin-Qt notifications under Growl 1.3.
Increase required age of Merdecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxMerdecoin properly when installing Merdecoin-Qt over it. (Windows)
