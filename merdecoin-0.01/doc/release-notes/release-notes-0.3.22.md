Download URL: https://sourceforge.net/projects/merdecoin/files/Merdecoin/merdecoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 MRD fee schedule (users still pay 0.01 MRD per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #merdecoin00 - #merdecoin99
