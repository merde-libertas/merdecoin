...
(define* (make-merdecoin-cross-toolchain target
                                  #:key
...
desirable for building Merdecoin Core release binaries."
...
(packages->manifest
 (list ;; The Basics
       ...
       (make-merdecoin-cross-toolchain "i686-linux-gnu")
       (make-merdecoin-cross-toolchain "x86_64-linux-gnu")
       (make-merdecoin-cross-toolchain "aarch64-linux-gnu")
       (make-merdecoin-cross-toolchain "arm-linux-gnueabihf")
       ...
       (make-merdecoin-cross-toolchain "riscv64-linux-gnu"
