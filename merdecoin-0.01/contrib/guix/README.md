# Bootstrappable Merdecoin Core Builds

This directory contains the files necessary to perform bootstrappable Merdecoin
Core builds.
...
- 24GB of free disk space on the partition that the Merdecoin Core git repository
  resides in
...
For a Merdecoin Core depends development environment, simply invoke
...
From the top of a clean Merdecoin Core repository:
...
To use dongcarl's substitute server for Merdecoin Core builds after having
