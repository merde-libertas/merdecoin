...
Additional tools, including the `github-merge.py` script, are available in the [maintainer-tools](https://github.com/merdecoin-core/merdecoin-maintainer-tools) repository.
