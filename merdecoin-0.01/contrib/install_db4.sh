...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the merdecoin repository."
  exit 1
fi
...
# See https://github.com/merdecoin/merdecoin/issues/16064
...
echo 'When compiling merdecoind, run `./configure` in the following way:'
echo
