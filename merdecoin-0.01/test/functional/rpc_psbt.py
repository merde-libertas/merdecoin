...
class PSBTTest(MerdecoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 MRD
        ...
        # feeRate of 0.1 MRD / KB produces a total fee slightly below -maxtxfee (~0.05280000):
        ...
        # feeRate of 10 MRD / KB produces a total fee well above -maxtxfee
