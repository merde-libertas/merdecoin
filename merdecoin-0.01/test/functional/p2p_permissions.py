...
class P2PPermissionsTests(MerdecoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].merdecoinconf, encoding="utf8") as f:
            newText=f.read().replace(old, new)
        with open(self.nodes[nodeid].merdecoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
