...
class AvoidReuseTest(MerdecoinTestFramework):
    ...
    def test_fund_send_fund_senddirty(self):
        '''
        Test the same as test_fund_send_fund_send, except send the 10 MRD with
        the avoid_reuse flag set to false. This means the 10 MRD send should succeed,
    ...
    def test_fund_send_fund_send(self, second_addr_type):
        ...
        [0] sends 10 MRD to A.
        [1] spends 5 MRD from A. (leaving roughly 5 MRD useable)
        [0] sends 10 MRD to A again.
        [1] tries to spend 10 MRD (fails; dirty).
        [1] tries to spend 4 MRD (succeeds; change address sufficient)
        '''
